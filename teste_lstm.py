...
Original file is located at
    https://colab.research.google.com/drive/1uflb6QNpVVzeBkfeEzNUxvXCuScY8ilj
...
class LSTM(nn.Module):
    ...
    def forward(self, x):
        hidden_cell0 = torch.zeros(self.num_layers, x.size(0), self.hidden_size)
        hidden_cell1 = torch.zeros(self.num_layers, x.size(0), self.hidden_size)

        predictions, _ = self.lstm(x, (hidden_cell0, hidden_cell1 ))
        predictions = self.fc(predictions[:, -1, :])
        return predictions
